...
const ReferAndEarnRegularTransactionHistory = ({ modalValue, handleOpenModal,setDistTab }) => {
  ...
  const [filterData, setFilterData] = useState({
    ...
    statusField: "Refer & Earn (Regular)",
  });
      ...
      <div className={"tds-all-user-section"}>
        <Paper sx={{ mb: 2 }} className="outer-box">
          <div className={"tds-main-section"}>
            ...
            <p
            className={
              rowData?.TotalWallet?.ReferAndEarnRegularTransactionHistory?.toString()?.includes("-")
                ? "amount loss_color"
                : ""
            }
          >
...
export default ReferAndEarnRegularTransactionHistory;
