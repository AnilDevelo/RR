...
const GameLeaderBoardTransactionHistory = ({ modalValue, handleOpenModal,setDistTab }) => {
  ...
  const [filterData, setFilterData] = useState({
    ...
    statusField: "Total Monthly Game Leaderboard",
  });
...
export default GameLeaderBoardTransactionHistory;
