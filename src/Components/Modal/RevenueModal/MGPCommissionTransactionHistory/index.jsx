...
const MGPCommissionTransactionHistory = ({handleOpenModal,setSwitchTab}) => {
  ...
  const [filterData, setFilterData] = useState({
    ...
    statusField: "MGP Platform Commission",
  });
  ...
  return (
    <>
      <div className={"tds-all-user-section"}>
        <Paper sx={{ mb: 2 }} className="outer-box">
          <div className={"tds-main-section"}>
            ...
            <h2>Total MGP Platform Commission : </h2>
            <p
            className={
      ...
      <Paper sx={{ mb: 2 }} className="outer-box platform_section">
        {/* <div className={"totalMGPWallets"}>
          <h3>Total MGP Platform Commission : </h3>
          <p
            className={
...
export default MGPCommissionTransactionHistory;
