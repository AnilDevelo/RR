...
const GSTPercentageDropdown = ({formData, setFormData, name, isDisabled,placeholder}) => {
    ...
    return(
        <div className={'filter_days_details_dropDown gst-dropdown_width'}>
            <FormControl className={classes.margin}>
                ...
                >
                    {
                        Array.from(Array(101))?.map((item,i) => {
                            return <MenuItem value={i} className={'filter_dropdown_list'}>{i}%</MenuItem>
                        })
                    }
                </Select>
            </FormControl>
...
export default GSTPercentageDropdown