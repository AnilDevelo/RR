...
const PercentageDropdown = ({ formData, setFormData, name, isDisabled, placeholder, style }) => {
    ...
    return(
        <div className={'filter_days_details_dropDown gst-dropdown_width'} style={style}>
