...
import {ActivateDeactivateLobbyList} from "../../../Redux/games/action";
import {Box, Button} from "@mui/material";
import Typography from "@mui/material/Typography";
import FilledButton from "../../../Components/FileButton";
import {activeDeactivateMgpReleases} from "../../../Redux/MGPRelease/action";
...
const ActiveDeactivateMGPRelease = ({ modalValue, handleOpenModal, redirectApiHandler }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoader(true);
        let payload = {
            MgpReleaseId: modalValue?.MgpReleaseId,
            isActive: modalValue?.isActive
        }
        dispatch(activeDeactivateMgpReleases(payload)).then(res => {
            if (res.data.success) {
                setLoader(false);
                redirectApiHandler();
...
export default ActiveDeactivateMGPRelease