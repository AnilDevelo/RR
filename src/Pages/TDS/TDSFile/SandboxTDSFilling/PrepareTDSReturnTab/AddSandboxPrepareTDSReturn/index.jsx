...
import {addSandboxPrepareTDSReturn, addTDSFilling} from "../../../../../../Redux/TDSReport/action";
...
const AddSandboxPrepareTDSReturn = ({modalValue, handleOpenModal, redirectApiHandler}) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (simpleValidator.current.allValid()) {
            let payload = {
                ...
                previous_rrr_number: formData?.previous_rrr_number
            }
        ...
        <Box sx={style}>
            <Box className={'add_admin_user_popup modal_main_popup game-mode-config-design tds_file_section sandbox_tds_popup lobby_section_details'}>
                <div className={'modal_popup_title'}>
                    ...
                    <h2>{'Sandbox Prepare TDS Return'}</h2>
                </div>
                        ...
                        <div className={'user_kyc_section'}>
                            ...
                            <div className={'d_flex w_100 gap_20'}>
                                <div className={'formData user_kyc_section_filed w_100 mr_margin'}>
                                    ...
                                    <div className={'user_kyc_section_input_filed lobby-type-description'} style={{marginTop:"5px"}}>
                            ...
                            <div className={'d_flex w_100 gap_20'}>
                                ...
                                <div className={'formData user_kyc_section_filed w_100 ml_margin'}>
                                    <label>Filing Type <span className={'validation-star'}>*</span></label>
                                    <div className={'user_kyc_section_input_filed lobby-type-description'} style={{marginTop:"5px"}}>
                                        <CommonDropdown options={['Original']} name={'filing_type'} setFormData={setFormData} formData={formData} />
                                    </div>
                                    {simpleValidator.current.message("filing_type", formData?.filing_type, 'required')}
                                </div>
                            </div>
                            <div className={'formData user_kyc_section_filed w_100 mr_margin'}>
                                <label>Previous RRR Number</label>
                                <div className={'user_kyc_section_input_filed lobby-type-description'}>
                                    <input type={'text'} placeholder={'Enter Previous RRR Number'}  value={formData?.previous_rrr_number} name={'previous_rrr_number'}  onChange={(e)=>changeHandler(e)}  />
                                </div>
                            </div>
                        </div>
...
export default AddSandboxPrepareTDSReturn