...
const ActiveDeactivateLobby = ({ modalValue, handleOpenModal, redirectApiHandler }) => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoader(true);
        let payload = {
            headToHeadId: modalValue?.headToHeadId,
            isActive: modalValue?.isActive
        }
        dispatch(ActivateDeactivateLobbyList(payload)).then(res => {
            if (res.data.success) {
                setLoader(false);
...
export default ActiveDeactivateLobby