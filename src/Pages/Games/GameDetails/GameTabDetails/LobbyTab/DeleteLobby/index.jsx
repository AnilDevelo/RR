...
import {deleteGameLobbyList} from "../../../../../../Redux/games/action";
...
const DeleteLobby = ({ modalValue, handleOpenModal }) => {
    ...
    const handleSubmit = (event) => {
        ...
        setLoader(true);
        let payload = {
            headToHeadId: modalValue?.id
        }
        dispatch(deleteGameLobbyList(payload)).then(res => {
            if (res.data.success) {
