...
import GameBuildDropDown from "../AddGameBuilds/GameBuildDropDown";
...
const UpdateGameBuild = ({ modalValue, handleOpenModal, redirectApiHandler }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        isUploadGameWiseModeBuild:modalValue?.isUploadGameWiseModeBuild,
        gameModeId: modalValue?.gameModeId,
        isUploadNewScene:modalValue?.isUploadNewScene
    ...
    const handleSubmit = (e) => {
        ...
        if (simpleValidator.current.allValid()) {
            ...
            delete  payload?.mgpReleaseArray
            setLoader(true)
                    ...
                    <div className={''}>
                        <div className={'manage_game_builds_details_field field_tab_build01'}>
                            <div className={'manage_game_builds_details_flex'}>
                                <div className={'release_Guide_section'}>
                                    <div className="formData">
                                        ...
                                        <div className="emailWrap">
                                            <input type="text" name='releaseVersion' placeholder={'Enter Version'} value={formData?.releaseVersion} onChange={(e) => setFormData({ ...formData, releaseVersion: e.target.value })} />
                                        </div>
                                ...
                                <div className={'select_game_option_mode mb_build'}>
                                    ...
                                    <GameBuildDropDown options={gameBuildMPGRelease} formData={formData} name={'mgpReleaseId'} setFormData={setFormData} />
                                    </div>
                            ...
                            <div className={'game_mode_btn'}>
                                ...
                                <div className={'game_mode_btn_option no_radio_btn'}>
                                    <input type="radio" name='isUploadNewScene' style={{cursor:"no-drop"}} disabled checked={!formData?.isUploadNewScene} className={'checkbox_field_tournament'} onChange={(e) => setFormData({ ...formData, isUploadNewScene: false })}/>
                                    <label>No</label>
                                </div>
                            </div>
                        </div>
                                <div className={'game_build_uploader'}>
                                    ...
                                    {/*</div>*/}
                                    <div className={'user_kyc_section_filed_document'}>
                                        <label>Scene <span className={'validation-star'}>*</span></label>
                                        <div className={'document_details_kyc'}>
                                            <div className="u_flex u_align-center">
                                                <div className="u_file-attachment add ">
                                                    <svg width="18" height="18" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="">
                                            ...
                                            <div className={'document_details_kyc'}>
                                                <div className="u_flex u_align-center">
                                                    <div className="u_file-attachment add ">
                                                        ...
                                                        <div className="u_file-attachment-label">
                                                                <input type="file" title="" name={'buildAndroidAssets'} id="upload" autoComplete="off" onChange={(e) => handleFileChanges(e)} />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className={'document_details_kyc'}>
                                                <div className="u_flex u_align-center">
                                                    <div className="u_file-attachment add ">
                                                        ...
                                                        <div className="u_file-attachment-label">
                                                            <input type="file" title="" accept=".zip" name={'buildIosAssets'} id="upload" autoComplete="off" onChange={(e) => handleFileChanges(e)} />
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className={'manage_game_builds_details_field field_tab_build02'}>
                            <div className={'text-editor-details-section'}>
                                <label className={'main_label'}>Release Notes <span style={{color:"red"}}>*</span></label>
                                <div className={'mt_margin'}>
                                    <TextEditor handleChange={handleEditor} value={formData?.releaseNotes}/>
                                </div>
                            ...
                            {/*            <div className="emailWrap">*/}
                            {/*                <input type="text" name='codeUrl' placeholder={'Enter Code URL'} value={formData?.codeUrl} onChange={(e) => setFormData({ ...formData, codeUrl: e.target.value })} />*/}
                            {/*            </div>*/}
                            {/*        </div>*/}
                            {/*    </div>*/}
                            {/*</div>*/}
